...
console.log(xS[xS.length - 1] - xS[0]);
console.log(yS[yS.length - 1] - yS[0]);
canvas.width = xS[xS.length - 1] - xS[0];
canvas.height = yS[yS.lenth - 1] - yS[0];
...
function Animate(num) {
  ...
  console.log(i);
  ctx.fillStyle = "#aee3a0";
  ctx.beginPath();
  ctx.arc((lightCoords[i][0] - xS[0]) + 5, (lightCoords[i][1] - yS[0]) + 5, 4, 0, 2 * Math.PI);
  ctx.fill();
  i++;
} 
let interval = setInterval(Animate, 25, i);
